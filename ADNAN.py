...
.______    _______           ___       _______  .__   __.      ___      .__   __. 
...
|______/  |_______/     /__/     \__\ |_______/ |__| \__| /__/     \__\ |__| \__| 

                                                                      

{Y}*******************************************************

{B} [{R}✔{B}] {Y}DEVELOPER  :{G}  BD-ADNAN

{B} [{R}✔{B}] {B}FACEBOOK   :{G} ADNAN WASIF SHAKIL

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} +8801758329292
...
def fb():
    ...
    s("xdg-open https://www.facebook.com/jonising.com12")

def git():

    s(" os.system('xdg-open https://www.facebook.com/jonising.com12")
...
def o():
    ...
    if opt == '1':
        ...
        s("https://www.facebook.com/jonising.com12")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdout.write('\r %s[ADNAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
